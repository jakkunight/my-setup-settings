...
# Unsets the PREFIX for Termux-based environments and NVM:
unset PREFIX

# Sets micro and vscode as default editor:
export EDITOR=nvim
export VISUAL=nvim
...
# Enhanced NNN. Syncs subshell with cd.
n(){
...
# Starts aa VNC session with Xfce4:
xfce4vnc(){
...
# fnm
export PATH="/home/jakku/.local/share/fnm:$PATH"
eval "`fnm env`"
